const CreateTask = () => {
  ...
  return (
    <div className="mt-10 bg-customDark pt-4 rounded-md">
      <form
      ...
      >
        ...
        <div className="w-2/5 flex flex-col items-start">
          ...
          <textarea className="w-full h-[10.8rem] text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4"></textarea>
